...
public sealed class SystemApi
{
    ...
    internal SystemApi(GVxClient client) => _client = client;
    ...
    public async Task<string> GetWechatBasePathAsync(CancellationToken cancellationToken = default)
    {
        ...
        return GVxClient.GetRequiredProperty(response, "data").GetString() ?? string.Empty;
    }
    ...
    public async Task<string> GetConfigPathAsync(CancellationToken cancellationToken = default)
    {
        ...
        return GVxClient.GetRequiredProperty(response, "configPath").GetString() ?? string.Empty;
    }
    ...
    public async Task<LoginStatusResponse> GetLoginStatusAsync(CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new GVxApiException($"gVx login API error: errCode={response.ErrCode}");
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var data = GVxClient.GetRequiredProperty(response, "data");
        return GVxClient.GetRequiredProperty(data, "scan_res").GetString() ?? string.Empty;
    }
